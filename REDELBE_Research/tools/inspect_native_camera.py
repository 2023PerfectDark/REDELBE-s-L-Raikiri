"""Read-only, bounded scan of one DOA6LR process for statically verified native camera vtable."""
...
try:
 ...
 ids={int(sys.argv[2],16)+r:'camera_type_'+hex(r) for r in (0x4272448,)}
 ...
 (catalog.parent/'native_camera_scan.json').write_text(json.dumps(result,indent=2))
